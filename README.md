...
This repository serves as my playground for experimenting with different datasets and work on projects that interest me in any way. The goals of this repository are simple:
1. Analyze data to find insights and observations that are not visible to the naked eye
2. Demonstrate proficiency in data science and machine learning concepts

### KNN Adult Income:

Using the K-Nearest Neighbors Algorithm to predict adult income ranges based on a dataset obtained from UC Irvine
